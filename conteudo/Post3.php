               ...
               <div class="search-container">
                      ...
                      <!-- Conteudo !-->
                            <div class="conteudo"><br>
                                <a class="Ancora"></a>
                                <h1 style="margin-bottom: 40px;">Existem restaurantes veganos?</h1>

                                <h2>Autor: <a class="link"style="text-decoration: none;">Luiz089</a>
                                  <br><br>
                                <p>Existe algum restaurante vegano aqui em Minas Gerais?
