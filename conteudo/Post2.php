               ...
               <div class="search-container">
                      ...
                      <!-- Conteudo !-->
                            <div class="conteudo"><br>
                                <a class="Ancora"></a>
                                <h1 style="margin-bottom: 40px;">Ser vegano custa no bolso?</h1>

                                <h2>Autor: <a class="link"style="text-decoration: none;">Menino3k</a>
                                  <br><br>
                                <p>Olá sempre quis ser vegano, mas sempre ouço que para virar vegano precisa ter muito dinheiro. Tenho curiosidade se isso é verdade.
