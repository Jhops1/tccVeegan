...
<html lang="pt">
    ...
    <body>
        ...
        <div class="noselect" id="navbar">
            ...
            <div id="navbar-right">
                <a id="textmenu1" href="conteudo/veganismo.php">Veganismo</a>
                <a id="textmenu2" href="conteudo/vegetarianismo.php">Vegetarianismo</a>
        ...
        <div class="banner2 noselect container">
            ...
            <button class="card pointer" id="myBtn">
                <a href="login.php"><h2>Ir para os Fóruns</h2></a>
            </button>
        </div>
